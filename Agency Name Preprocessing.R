...
# dat<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Original Acronyms.csv")
# dat1<-filter(dat, !grepl("^[[:digit:]]+", Agency)) # agency names that do not start with a number
# dat2<-filter(dat, grepl("^[[:digit:]]+", Agency))# agency names that start with a number

#### Appened Abbreviations in the Dictionary ####
dat<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Dictionary\\Stakeholder Dictionary.csv")
dat<-dat[,2:3]
# Remove duplicated abbreviations 
dat$Abbr<-as.character(dat$Abbr)
abbr<-dat$Abbr[!duplicated(dat$Abbr)]
# Append abbreviations
dat_abbr<-data.frame(Abbr=abbr, Agency=abbr)
dict_abbr<-rbind(dat,dat_abbr)
colnames(dict_abbr)<-c("id","agency")
# write.csv(dict_abbr, "G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Dictionary\\Dictionary_abbr.csv")

#### Collaboration Visualization ####
HU_stakeholder<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\HU_stakeholder.csv")
HU_interaction<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\HU_interaction.csv")
SS_stakeholder<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\SS_stakeholder.csv")
SS_interaction<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\SS_interaction.csv")
FL_stakeholder<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\FL_stakeholder.csv")
FL_interaction<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\FL_interaction.csv")
FI_stakeholder<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\FI_stakeholder.csv")
FI_interaction<-read.csv("G:\\My Drive\\GMU Material\\GMU Course\\Spring 2021\\DAEN 690\\Code and Data\\Collaboration Information\\FI_interaction.csv")
...
SS_SH_freq<-stakeholder_freq(SS_stakeholder)
SS_IN_freq<-interaction_freq(SS_interaction)
FL_SH_freq<-stakeholder_freq(FL_stakeholder)
FL_IN_freq<-interaction_freq(FL_interaction)
FI_SH_freq<-stakeholder_freq(FI_stakeholder)
FI_IN_freq<-interaction_freq(FI_interaction)
